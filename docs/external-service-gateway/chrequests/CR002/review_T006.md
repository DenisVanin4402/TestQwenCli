...
Решение согласовано с ADR-012: рабочий вход OpenAPI-генерации находится внутри Maven-модуля, а наличие второй копии в `docs` компенсировано тестом синхронности.
...
- CR002-T009 должен был усилить stable contract checks, включая note из `review_T005.md`; на финальном закрытии CR002 этот этап пропущен по решению пользователя, а note отложен за пределы текущего CR002;
