...
| 9 | CR003-T009: parity и concurrency проверки | P0 | Рефакторинг проходит существующие contract, e2e и PostgreSQL concurrency tests; при JPA добавлены отдельные parity tests. |
