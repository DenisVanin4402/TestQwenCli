...
@Service
public class CallbackDeliveryDispatcherImpl implements CallbackDeliveryDispatcher {

	private static final Logger log = LoggerFactory.getLogger(CallbackDeliveryDispatcherImpl.class);
	...
	public CallbackDeliveryDispatcherImpl(
