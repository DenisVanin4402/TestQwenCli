...
@Service
public class CallbackDeliveryPlannerImpl implements CallbackDeliveryPlanner {

	private static final Logger log = LoggerFactory.getLogger(CallbackDeliveryPlannerImpl.class);
	...
	public CallbackDeliveryPlannerImpl(
